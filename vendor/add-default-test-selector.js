...
(function() {
  Ember.Component.reopen({
    init: function() {
      if (this.get('tagName') !== '' && Ember.isEmpty(this.get('data-test-selector'))) {
        this.set('data-test-selector', Object.getPrototypeOf(this)._debugContainerKey.replace(/^component:/, ''));
      }
